        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="index.html"><img
                        src="{{ asset('admincss/images/logo.svg') }}" class="mr-2" alt="logo" /></a>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card tale-bg">
                                <div class="card-people mt-auto">
                                    <img src="{{ asset('admincss/images/dashboard/people.svg') }}" alt="people">
                    ...
                    <body>
                        ...
                        <script>
                            // Data mockup (ganti dengan data dari backend jika diperlukan)
                            const labels = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'];
                            const targetData = [4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000]; // Data target
                            const realisasiData = [4500, 3500, 4200, 4000, 4400, 4200, 4700, 3900, 4100, 4200, 4500, 4600]; // Data realisasi
